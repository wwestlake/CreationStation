    ...
    const CreationStationContextEngine::ContextPacket& packet) const
{
    ...
    switch (workflow)
    {
        ...
        case WorkflowKind::instrumentDesign:
            ...
            plan.suggestedTools.addArray({ "Signal Lab", "FRust", "Patch Graph", "Djehuti Station Instrument" });
        ...
        default:
            ...
            plan.suggestedTools.addArray({ "AI Context", "Signal Lab", "FRust", "Patch Graph" });
