...
#ifndef KSPROPERTY_JACK_DESCRIPTION3
#define KSPROPERTY_JACK_DESCRIPTION3 3
typedef struct _KSJACK_DESCRIPTION3
{
    ULONG ConfigId;
} KSJACK_DESCRIPTION3, *PKSJACK_DESCRIPTION3;
#endif

#ifndef KSPROPSETID_AudioResourceManagement
...
typedef enum _KSPROPERTY_AUDIORESOURCEMANAGEMENT
{
    KSPROPERTY_AUDIORESOURCEMANAGEMENT_RESOURCEGROUP = 0
} KSPROPERTY_AUDIORESOURCEMANAGEMENT;

typedef struct _AUDIORESOURCEMANAGEMENT_RESOURCEGROUP
{
    BOOL ResourceGroupAcquired;
    WCHAR ResourceGroupName[128];
