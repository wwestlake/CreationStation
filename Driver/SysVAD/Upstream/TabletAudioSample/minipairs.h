...
{
    eSpeakerDevice,
    L"TopologyDjehutiRouterMonitor",                       // make sure this or the template name matches with KSNAME_TopologyDjehutiRouterMonitor in the inf's [Strings] section
    NULL,                                                   // optional template name
    CreateMiniportTopologySYSVAD,
    &SpeakerTopoMiniportFilterDescriptor,
    0, NULL,                                                // Interface properties
    L"WaveDjehutiRouterMonitor",                            // make sure this or the template name matches with KSNAME_WaveDjehutiRouterMonitor in the inf's [Strings] section
    NULL,                                                   // optional template name
    CreateMiniportWaveRTSYSVAD,
...
{
    eMicInDevice,
    L"TopologyDjehutiRouterCapture",       // make sure this or the template name matches with KSNAME_TopologyDjehutiRouterCapture in the inf's [Strings] section
    NULL,                                   // optional template name
    CreateMiniportTopologySYSVAD,
    &MicInTopoMiniportFilterDescriptor,
    0, NULL,                                // Interface properties
    L"WaveDjehutiRouterCapture",            // make sure this or the template name matches with KSNAME_WaveDjehutiRouterCapture in the inf's [Strings] section
    NULL,                                   // optional template name
    CreateMiniportWaveRTSYSVAD,
